...
try:
    ...
    print("\033[92m [+] Welcome To Admin Page Finder Tool ")
...
bannerprint('''\033[92m
 _____ _______      _______ _     _ _____ _______      __   __  _____  _     _  ______      _______ ______  _______ _____ __   _
   |   |______         |    |_____|   |   |______        \_/   |     | |     | |_____/      |_____| |     \ |  |  |   |   | \  |
 __|__ ______|         |    |     | __|__ ______|         |    |_____| |_____| |    \_      |     | |_____/ |  |  | __|__ |  \_|
...
slowprint(" [!] Loading Admin Page Finder Tool For You... ")
time.sleep(2)
os.system('cls')
print('''\033[92m
 _____ _______      _______ _     _ _____ _______      __   __  _____  _     _  ______      _______ ______  _______ _____ __   _
...
''')
print(" \033[95m YOU MUST WRITE PROTOCOL HTTPS:// or HTTP:// ex: http://www.ex.com , ex :https://www.ex.com ")
print(" \033[95m YOU MUST WRITE / AT THE END OF THE SITE EX: http://www.example.com/ or https://www.example.com/")
print("                                                                       ")
url = input("\033[94m [+] Wants You To Enter Target Website : ")
input("\n\033[91m [*] Attack Strategy is loaded.... Enter To Continue or Ctrl+C to Exit")

if not url.startswith(('http://', 'https://')):
    print("\033[91m [] Please enter the Link only")
    sys.exit()
...
def slowprint(f):
    for c in f + '\n':
        ...
        sys.stdout.flush()
        time.sleep(10. / 100)
slowprint('''\033[91m [+] Is On Progress... Feel Free To Press Ctrl+C At Any Point To Abort... ''')
time.sleep(2)
...
try:
	...
	def slowprint(f):
		for c in f + '\n' :
			...
			sys.stdout.flush()
			time.sleep(10. / 100)
	slowprint("\n\033[91m [+] Exiting.... Thanks For Using My Tool 3n8ry  \n")
	time.sleep(2)
	os.system('clear')
except KeyboardInterrupt:
	print( "\n\033[90m [-] See You Again 3n8ry ^-^ ")